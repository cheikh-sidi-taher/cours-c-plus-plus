...
{
    // Codes d'échappement ANSI pour changer la couleur du texte
    switch (Winner)
    {
    case enWinner::Player1:
        cout << "\033[1;32m"; // Vert pour Player1
        break;
    case enWinner::Computer:
        cout << "\033[1;31m"; // Rouge pour Computer
        cout << "\a"; // Émet un son
        break;
    default:
        cout << "\033[1;33m"; // Jaune pour Draw (égalité)
        break;
    }
}
...
{
    cout << "\n____________Round [" << RoundInfo.RoundNumber << endl;
        cout
